# [Ansible role kubectl](#ansible-role-kubectl)

Install the latest stable version of kubectl on your system.

|GitHub|Issues|Pull Requests|Version|Downloads|
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-kubectl/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-kubectl/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-kubectl.svg)](https://github.com/buluma/ansible-role-kubectl/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-kubectl.svg)](https://github.com/buluma/ansible-role-kubectl/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-kubectl.svg)](https://github.com/buluma/ansible-role-kubectl/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/kubectl)](https://galaxy.ansible.com/ui/standalone/roles/buluma/kubectl/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-kubectl/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-kubectl/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-kubectl
